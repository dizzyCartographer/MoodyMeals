...
4. ~~**Wednesday collision**~~ **Dissolved per D-47 (Ria, 2026-07-09):** ramen Wednesday is a genuine example AND all seed data is disposable — no seeded schedule is a product decision; workbook item 3 gathers the real cook nights. Both coexist in seed (b4d anchor stays inactive per D-1).
