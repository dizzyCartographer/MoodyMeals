...
- **[F14] Delete rules are unpinned in spec §2 — SCOPE WIDENED by the M0-4 review (all for one D-37 decision).** Deleting a Meal or a FamilyMember leaves dangling references that TRAP on access (all empirically verified). The full set now:
